...
// Perry "Established" mark for the social feed (ENG-882 / ENG-895). Mirrors the main app's
// EstablishedFrame (packages/ui .../standing/EstablishedFrame.tsx): a transparent gold ring + seal
// OVERLAY sized to the avatar, with per-tier construction (never colour alone). Kept self-contained
// here because this vendored UIKit cannot import the host app's ui package; the gold/platinum
// palette values are copied from the host's shared BADGE_THEME (light) — keep them in sync.
