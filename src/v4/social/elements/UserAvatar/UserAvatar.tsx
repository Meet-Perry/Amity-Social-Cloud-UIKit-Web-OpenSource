...
export function UserAvatar({
  ...
  // Perry Established mark (ENG-882 / ENG-895). Driven by fields the host app writes onto the Amity
  // user's metadata: `established` (bool), `hideEstablishedBadge` (bool opt-out), `establishedTier`.
